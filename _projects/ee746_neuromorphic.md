...
<object data="{{ '/assets/pdf/EE746_project1.pdf' | relative_url }}" type="application/pdf" width="100%" height="600px">
  <p>PDF cannot be displayed. <a href="{{ '/assets/pdf/EE746_project1.pdf' | relative_url }}">Download PDF</a></p>
</object>
